...
Additionally you will need CUDA, NVCC, and g++. On Arch linux I just use install cuda from pacman Extra repo, but this is system dependent. You will of course need an Nvidia GPU as well.
